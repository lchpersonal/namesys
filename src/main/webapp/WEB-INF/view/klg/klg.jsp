...
<div style="border-bottom: 2px ridge #b6262f;" class="pb2 mb10">
    ...
    <span class="mleft30">行业知识</span>
    <a href="/jst/klg/addKlg" id="homepage" class="fr f18 m0 p0 dib red tdn">添加</a>
</div>
...
<script type="text/javascript">
    $(function () {
        ...
        function getData(maxId, keyword) {
            $.post("/klg/select.json", {curId: maxId, keyword: keyword}, function (data) {
                if (data.result.code == 0) {
                    ...
                    if (data.result.t != null) {
                        for (var i = 0; i < data.result.t.length; i++) {
                            obj = data.result.t[i];
                            var title = highlight(obj.title, keyword);
        ...
        $("body").on("click", ".edit", function () {
            ...
            location.href = "/klg/editPage?id=" + infoid;
        });
